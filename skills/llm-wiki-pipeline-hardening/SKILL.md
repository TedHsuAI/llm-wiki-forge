...
<python_command> -m llm_wiki_forge graph --wiki-root "<wiki_root>" --question "<evidence_repo> 的主要責任是什麼？" --top 5 --extract --extract-limit 4
<python_command> -m llm_wiki_forge graph --wiki-root "<wiki_root>" --question "<evidence_repo> 有哪些主要入口點？" --top 5 --extract --extract-limit 4
```
